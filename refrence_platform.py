...
is_32_bit_float = False
will_format=False
CODE_FILE_NAME = "_gen_ccode.c"
FACNY_FILE_NAME = "_formated_ccode.c"
DLL_FILE_NAME = "_gen_dll.so"
OUT_NAME = "out"
IN_NAME = "in"
MED_NAME = "med"
NUMTY = "Float"#uneditable as of now
BASIC_C_INDEX_TYPE = "unsigned long long"
INDEX_TY = "uint64_t"#uneditable as of now
KERN_NAME = "kern"
BUFF_NAME = "buf"
#using 64 bit integer pointer things
